...
class PolynomialTest {
    ...
    @Test
    void constructorDoubleNullParameterShouldThrowException() throws Exception {
    ...
    @Test
    void constructorStringNullParameterShouldThrowException() throws Exception {
    ...
    @Test
    void constructorStringInvalidCoefficientShouldThrowException() throws Exception {
    ...
    @Test
    void constructorStringShouldConvert() throws Exception {
